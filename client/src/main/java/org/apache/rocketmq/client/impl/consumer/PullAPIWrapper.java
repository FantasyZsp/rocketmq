...
public class PullAPIWrapper {
    ...
    /**
     * 维护拉取MessageQueue时用到的brokerId，会在每次拉取完毕后更新
     */
    ...
    public PullResult pullKernelImpl(
        ...
        // 从本地订阅信息找broker地址，没找到就更新一下继续找。还没找到就抛错了。
